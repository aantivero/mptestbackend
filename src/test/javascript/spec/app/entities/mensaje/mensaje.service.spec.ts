...
describe('Service Tests', () => {
    ...
    describe('Mensaje Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MensajeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/mensajes/' + 123);
            });
            it('should return Mensaje', () => {

                let entity: Mensaje;
                service.find(123).subscribe((_entity: Mensaje) => {
                    entity = _entity;
                });
